package com.bawp.myproject.Activities;
...
public class ShowListEarthQuakes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_list_earth_quakes);
        arrayList = new ArrayList<>();
        queue = Volley.newRequestQueue(getApplicationContext());
        listView = findViewById(R.id.earthQuakes_list);
        getAllQues(Constants.URL);
    }

    private void getAllQues(String url) {
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    arrayAdapter = new ArrayAdapter<>(ShowListEarthQuakes.this, android.R.layout.simple_list_item_1, android.R.id.text1, arrayList);
